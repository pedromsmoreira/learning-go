...
func main() {
	...
	// When creating constants with regular expressions you can use the MustCompile
	// variation of Compile. A plain Compile won’t work for constants because it has 2 return values.
